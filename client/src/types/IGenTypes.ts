...
export type IGenPageSectionsDynamicZone = IGenComponentComponentsFeaturedProjects | IGenComponentComponentsGridCards | IGenComponentComponentsHeroSection | IGenComponentComponentsSelfTeaser | IGenError;
