...
export type IGenF_SeoFragment = { metaTitle: string | null, metaDescription: string | null, noIndex: boolean | null, metaImage: { url: string } | null };
...
export type IGenQ_Pages_By_SlugQuery = { pages: Array<{ title: string, slug: string, seo: { metaTitle: string | null, metaDescription: string | null, noIndex: boolean | null, metaImage: { url: string } | null } | null } | null> };
