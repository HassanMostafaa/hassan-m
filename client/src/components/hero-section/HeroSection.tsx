...
import { Globe, MoveUpRight, WholeWord } from "lucide-react";
...
> = ({ CallToAction, Subtitle, Title, tag }) => {
  ...
  return (
    <section className="flex max-w-5xl mx-auto min-h-[50vh] flex-col gap-4 items-center justify-center text-center">
      {tag && (
      ...
      {CallToAction?.ButtonText && (
        <Button
          ...
          startIcon={
            <span className="inline-flex rounded-full border border-border bg-background/80 p-2">
              <MoveUpRight
